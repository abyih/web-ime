...
A web-based Input Method Editor (IME) for Geez scripts. This project contains two versions of the IME:
...
- An on screen keyboard with support for the IME.

### 2. [Computer Keyboard](./desktop_ime/)

- A text area with support for the IME on which you can type with your keyboard.

## Features

- **Easy to Learn**: Uses a letter mapping system that is easy to understand.
- **Multi-language Support**: Configured for all languages which use the Geez Script and English.
